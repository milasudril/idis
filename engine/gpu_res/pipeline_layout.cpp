...
namespace
{
	auto create_pipeline_layout(VkDevice device)
	{
		...
		return idis::gpu_res::pipeline_layout::handle_type{ret,
		                                              idis::gpu_res::pipeline_layout_deleter{device}};
	}
}


idis::gpu_res::pipeline_layout::pipeline_layout(VkDevice device):m_handle{create_pipeline_layout(device)}{}