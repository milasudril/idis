...
TESTCASE(integer_mixin_zero) { EXPECT_EQ(my_special_integer::zero().value(), 0); }
...
TESTCASE(integer_mixin_add_assign)
{
	my_special_integer a{1};
	my_special_integer b{2};
...
TESTCASE(integer_mixin_sub_assign)
{
	my_special_integer a{1};
	my_special_integer b{2};
...
TESTCASE(integer_mixin_div_assign)
{
...
TESTCASE(integer_mixin_mul_assign)
{
	my_special_integer a{3};
